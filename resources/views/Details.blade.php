                    ...
                    <div class="col-md-9">
                        <div class="ms-3">
                            <div>
                                ...
                                <p class="mb-0 text-muted">Hi I'm {{$data->name}},has been the industry's standard
                                    dummy text To an English person alteration text.</p>
                            </div>
                            <div class="row my-4">
                                <div class="col-md-12">
                                    <div>
                                        <p class="text-muted mb-2 fw-medium"><i class="mdi mdi-email-outline me-2"></i>{{$data->email}}
                                        </p>
                            ...
                            <ul class="nav nav-tabs nav-tabs-custom border-bottom-0 mt-3 nav-justfied" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link px-4 active" data-bs-toggle="tab" href="#projects-tab" role="tab" aria-selected="false" tabindex="-1">
                                        ...
                                        <span class="d-none d-sm-block">Handle Courses</span>
                                    </a>
                                </li><!-- end li -->
                                <li class="nav-item" role="presentation">
